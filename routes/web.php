...
Route::get('/export/voluntarios', [ExportController::class, 'exportVoluntarios'])->name('export.voluntarios');
Route::get('/export/dependentes', [ExportController::class, 'exportDependentes'])->name('export.dependentes');